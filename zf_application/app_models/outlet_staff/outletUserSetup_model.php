...
class OutletUserSetup_Model extends Zf_Model {
    ...
    */
    public function registerNewUser(){
        ...
        if (empty($this->_errorResult)) {
            ...
            $outletCode = Zf_Core_Functions::Zf_CleanName($this->_validResult['outletId']);
            $userRole = ZIPPO_OUTLET_JUNIOR_STAFF;//user role
            ...
            if(!$zvss_executeUserSql){
                ...
                if($zvss_executeUserSql->RecordCount() > 0){
                    ...
                    if(!$executeInsertApplicationUser || !$executeInsertAdminDetails){
                        ...
                        Zf_GenerateLinks::zf_header_location('outlet_staff', 'manage_users', 'new_users');
                        exit(); 
