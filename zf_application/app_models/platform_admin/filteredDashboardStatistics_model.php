...
class FilteredDashboardStatistics_Model extends Zf_Model {
    ...
    */
    public function getTotalAmount($userid = NULL){
        ...
        if(!empty($startDate) && !empty($endDate)){
            ...
            $startDate = Zf_Core_Functions::Zf_FomartDate($dateFormat, $startDate);
            $endDate = Zf_Core_Functions::Zf_FomartDate($dateFormat, $endDate);
        ...
        if(empty($startDate) || empty($endDate)){
            ...
            $startDate = Zf_Core_Functions::Zf_FomartDate($dateFormat, $dateToday);
            $endDate = Zf_Core_Functions::Zf_FomartDate($dateFormat, $dateToday);
            
        }
        
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            
            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
    ...
    */
    public function getTotalCommissions($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalCommission  = "SELECT SUM(transactionCommission) AS totalCommissions FROM ". $table . " WHERE transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
    ...
    */
    public function getDepositsCommissions($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalCommission  = "SELECT SUM(transactionCommission) AS totalCommissions FROM ". $table . " WHERE transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
    ...
    */
    public function getWithdrawalsCommissions($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalCommission  = "SELECT SUM(transactionCommission) AS totalCommissions FROM ". $table . " WHERE transactionType = 'Withdrawal' AND  transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
    ...
    */
    public function getNumberOfTransactions($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalTransactions = "SELECT * FROM " . $table . " WHERE transactionDate BETWEEN '$startDate' AND '$endDate' "; //die();
    ...
    */
    public function getTotalDeposits($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
    ...
    */
    public function getTotalWithdrawals($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE transactionType = 'Withdrawal' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
    ...
    */
    public function getTotalInboundTransfer($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE transactionType = 'Inbound Transfer' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
    ...
    */
    public function getTotalOutboundTransfer($userid = NULL){
        ...
        if($application_user == ZIPPO_PLATFORM_ADMIN){
            ...
            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE transactionType = 'Outbound Transfer' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                ...
                if($viewType == "tabs"){
                    ...
                    $transactions_types .='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-10 indictaors-wrapper">';
                        ...
                        if($application_user == ZIPPO_PLATFORM_ADMIN){
                            ...
                            $totalAmount  = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table . " WHERE agencyTypeCode = '$agencyTypeCode' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
                               
                            $totalDepositCount  = "SELECT * FROM " . $table . " WHERE agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
                            $totalWithdrawalCount  = "SELECT * FROM " . $table . " WHERE agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Withdrawal' AND transactionDate BETWEEN '$startDate' AND '$endDate' ";//die

                            
                            $totalTransactions = "SELECT * FROM " . $table . " WHERE agencyTypeCode = '$agencyTypeCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
                                                         ...
                                                         $agency_types .= '<table class="table table-striped table-bordered table-hover"><thead>';
                                                                            ...
                                                                            $agency_types .= '<tr  style="text-align: center !important;">
                                                                                ...
                                                                                if($application_user == ZIPPO_PLATFORM_ADMIN){
                                                                                    ...
                                                                                    $totalDepositAmount  = "SELECT SUM(transactionAmount) AS totalDepositAmount FROM ". $table . " WHERE agencyEntityCode = '$agencyEntityCode' AND transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                    $totalDepositTransactions = "SELECT * FROM " . $table . " WHERE agencyEntityCode = '$agencyEntityCode' AND transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();

                                                                                    $totalWithdrawalAmount  = "SELECT SUM(transactionAmount) AS totalWithdrawalAmount FROM ". $table . " WHERE agencyEntityCode = '$agencyEntityCode' AND transactionType = 'Withdrawal' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                    $totalWithdrawalTransactions = "SELECT * FROM " . $table . " WHERE agencyEntityCode = '$agencyEntityCode' AND transactionType = 'Withdrawal' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
       ...
       $outletsResults = $this->fetchOutletsInformation();
        ...
        if($outletsResults == 0){
            ...
            foreach ($outletsResults as  $value) {
                ...
                $transactionInformation = $this->fetchTransactionsInformation($outletCode, $startDate, $endDate);
                                                         ...
                                                         $outlets_views .= '<table class="table table-striped table-bordered table-hover">
                                                                                ...
                                                                                foreach ($transactionTypeInformation as $value) {
                                                                                    ...
                                                                                    if($application_user == ZIPPO_PLATFORM_ADMIN){
                                                                                        ...
                                                                                        $totalTransactionAmount  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND transactionType = '$transactionTypeName' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                        $totalTransactionCount = "SELECT * FROM " . $table . " WHERE outletCode = '$outletCode' AND transactionType = '$transactionTypeName' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
                                                                                ...
                                                                                //Generate the SQL queries and the execute each query
                                                                                    if($application_user == ZIPPO_PLATFORM_ADMIN){
                                                                                        ...
                                                                                        $totalTransactionAmount  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                        $totalTransactionCount = "SELECT * FROM " . $table . " WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
                                                                                ...
                                                                                foreach ($agencyTypeInformation as $value) {
                                                                                    ...
                                                                                    if($agencyTypeName != "MTS"){
                                                                                        ...
                                                                                        if($application_user == ZIPPO_PLATFORM_ADMIN){
                                                                                            ...
                                                                                            $totalTransactionAmountDeposit  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Deposit' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                            $totalTransactionAmountWithdrawal  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Withdrawal' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                            $totalTransactionCount = "SELECT * FROM " . $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
                                                                                        ...
                                                                                        if($application_user == ZIPPO_PLATFORM_ADMIN){
                                                                                            ...
                                                                                            $totalTransactionAmountDeposit  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Inbound Transfer' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                            $totalTransactionAmountWithdrawal  = "SELECT SUM(transactionAmount) AS ".$amountColumn." FROM ". $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionType = 'Outbound Transfer' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die
                                                                                            $totalTransactionCount = "SELECT * FROM " . $table . " WHERE outletCode = '$outletCode' AND agencyTypeCode = '$agencyTypeCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  "; //die();
    ...
    */
    public function AllPartnersTransactionsPie($userid = NULL){
        ...
        if(!empty($startDate) && !empty($endDate)){
            ...
            $dateQuery = "transactionDate BETWEEN '$startDate' AND '$endDate' ";
        ...
        if($agencyTypesResults == 0){
            ...
            foreach ($agencyTypesResults as  $value) {
                ...
                if($application_user == ZIPPO_PLATFORM_ADMIN){
                    ...
                    $transactionName = "SELECT * FROM " . $table . " WHERE agencyTypeCode ='".$agencyTypeCode."' AND $dateQuery  "; //die();
                    

                }else if($application_user == ZIPPO_OUTLET_STAFF){

                    $transactionName = "SELECT * FROM " . $table . " WHERE agencyTypeCode ='".$agencyTypeCode."' AND outletIdNumber = '$userid' AND $dateQuery "; //die();
            ...
            foreach ($transactionsTypeResults as $value) {
                ...
                foreach ($agencyTypesResults as $value) {
                    ...
                    if($application_user == ZIPPO_PLATFORM_ADMIN){
                        ...
                        $getTransactionQuery = "SELECT SUM(transactionAmount) AS $sumAsValue FROM " . $table . " WHERE agencyTypeCode='$agencyTypeCode' AND transactionType='$transactionType' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die();;
            ...
            foreach ($transactionsTypeResults as $value) {
                ...
                foreach ($agencyTypesResults as $value) {
                    ...
                    if($application_user == ZIPPO_PLATFORM_ADMIN){
                        ...
                        $getTransactionQuery = "SELECT SUM(transactionAmount) AS $sumAsValue FROM " . $table . " WHERE agencyTypeCode='$agencyTypeCode' AND transactionType='$transactionType' AND $dateQuery "; //die();;
                    
                    }else if($application_user == ZIPPO_OUTLET_STAFF){
                        
                        $getTransactionQuery = "SELECT SUM(transactionAmount) AS $sumAsValue FROM " . $table . " WHERE agencyTypeCode='$agencyTypeCode' AND transactionType='$transactionType' AND outletIdNumber = '$userid' AND $dateQuery  "; //die();;
    ...
    */
    public function getOutletTransactions($userid = NULL){
        ...
        if($outletsResults == 0){
            ...
            foreach ($outletsResults as  $value) {
                ...
                $totalAmountTransacted = "SELECT SUM(transactionAmount) AS totalAmount FROM ". $table ." WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
                $totalCommissionTransacted = "SELECT SUM(transactionCommission) AS totalCommission FROM ". $table ." WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
                $totalTransactionCounts = "SELECT * FROM ". $table ." WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate' "; //die
     ...
     * -------------------------------------------------------------------------
     */
    private function fetchTransactionsInformation($outletCode, $startDate=NULL, $endDate=NULL){
        ...
        if(empty($startDate) || empty($endDate)){
            ...
            $startDate = $dateToday; $endDate = $dateToday;
            
        }
        
        
        $fetchTransactions = "SELECT * FROM " . $table . " WHERE outletCode = '$outletCode' AND transactionDate BETWEEN '$startDate' AND '$endDate'  ";
