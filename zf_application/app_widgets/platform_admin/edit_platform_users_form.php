...
<form id="subjectUpdateForm" action="<?php Zf_GenerateLinks::basic_internal_link("platform_admin", "editAdminUsers", $manageUsersParameters); ?>" method="post" class="form-horizontal" >
    <h3 class="form-section form-title">Edit Zeepo User</h3>    
    <div class="row">
        <div class="col-md-6" style="border-right: 1px solid #efefef; min-height: 100px !important; ">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <select class="form-control select2me userOptions" id="userOptions" name="identificationCode" data-placeholder="First name Second name"  value="<?php echo $zf_formHandler->zf_getFormValue("userIdentificationCode"); ?>">
                        <?php
                            $zf_widgetFolder = "platform_admin"; $zf_widgetFile = "select_options.php";  $zf_externalWidgetData = "editUserAdmins";
