...
?>
<form action="<?php Zf_GenerateLinks::basic_internal_link("platform_admin", "userSetup", $identificationCode); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="submit_form">
