...
<li class="<?php if (($active_menu_item[0] == "outlet_staff") && ($active_menu_item[1]== "manage_transactions")) { echo "active";} ?>">
    <a href="javascript:;">
        <i class="fa fa-exchange"></i>
        <span class="title">Zeepo Transactions</span>
        <?php if (($active_menu_item[0] == "outlet_staff") && ($active_menu_item[1]== "manage_transactions")) {?><span class="selected"></span><?php } ?>
        <span class="arrow <?php if (($active_menu_item[0] == "outlet_staff") && ($active_menu_item[1]== "manage_transactions")) { echo "open";} ?>"></span>
    </a>
    <ul class="sub-menu">
