        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">Manage Library</h3>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-folder-open"></i> Library Profile
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                                    <div id="tabbed-nav">
                                        <ul>
                                            <li><a></i>Library overview</a></li>
                                            <li><a><i class="fa fa-edit"></i> Manage library</a></li>
                                        </ul>
