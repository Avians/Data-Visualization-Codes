                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-book"></i> Subjects Profile
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                                    <div id="tabbed-nav">
                                        <ul>
                                            <li><a></i>Subjects overview</a></li>
                                            <li><a><i class="fa fa-plus-square"></i> Add a subject</a></li>
                                            <li><a><i class="fa fa-edit"></i> Manage subjects</a></li>
                                        </ul>
