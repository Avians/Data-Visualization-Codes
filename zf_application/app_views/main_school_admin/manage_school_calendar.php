        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">Manage School Calendar</h3>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zozo_tab_wrapper">
                                    <div id="tabbed-nav">
                                        <ul>
                                            <li><a></i>Calendar overview</a></li>
                                            <li><a><i class="fa fa-plus-square"></i> Add a calendar</a></li>
                                            <li><a><i class="fa fa-edit"></i> Manage calendar</a></li>
                                        </ul>
