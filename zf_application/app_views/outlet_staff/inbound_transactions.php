                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="portlet box blue">
                                                        ...
                                                        <div class="portlet-body" style="min-height: 300px !important;">
                                                            <?php //$zf_controller->zf_targetModel->AllInboundTransactionsPie($userid); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="portlet box blue">
                                                        <div class="portlet-title">
                                                            <div class="caption" >
                                                                <i class="fa fa-sign-in" style="color: #ffffff !important;"></i>Inbound Transactions (Last 7 Days)
                                                            </div>
                                                        </div>
                                                        <div class="portlet-body" style="min-height: 300px !important;">
                                                            <?php //$zf_controller->zf_targetModel->AllInboundTransactionsLine($userid); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
