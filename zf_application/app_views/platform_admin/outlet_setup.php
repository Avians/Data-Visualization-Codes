    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Outlet Types Setup</h3>
                                    ...
                                    <div>
                                        <div> 
                                            <?php 
                                                ...
                                                $zf_controller->zf_targetModel->getOutletTypes();
                                            ?>
                                        </div>
                                        <div>
                                            <?php
                                                //LOAD OUTLET SETUP FORM
                                                Zf_ApplicationWidgets::zf_load_widget("platform_admin", "add_outlet_form.php");
                                            ?> 
                                        </div>
                                        <div>
                                            <?php
                                                //We pull a dropdown of outlet types, from which an editing form appears
                                                $zf_controller->zf_targetModel->confirmOutletTypePresence();
                                            ?> 
                                        </div>
                                    </div>
                                </div>
