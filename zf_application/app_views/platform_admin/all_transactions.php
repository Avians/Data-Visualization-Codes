                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="portlet box blue">
                                                        <div class="portlet-title">
                                                            <div class="caption" >
                                                                <i class="fa fa-exchange" style="color: #ffffff !important;"></i>All Transactions Proportions
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="portlet box blue">
                                                        <div class="portlet-title">
                                                            <div class="caption" >
                                                                <i class="fa fa-exchange" style="color: #ffffff !important;"></i>All Transactions (Last 7 Days)
                                                            </div>
                                                        </div>
                                                        <div class="portlet-body" style="min-height: 300px !important;">
                                                            <?php //$zf_controller->zf_targetModel->AllTransactions($userid); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
