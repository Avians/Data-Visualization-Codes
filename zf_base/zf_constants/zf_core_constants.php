...
/**
 * -----------------------------------------------------------------------------
 * THESE HOLDS THE ROLES OF USERS WITHIN ZIPPO PLATFORM
 * -----------------------------------------------------------------------------
 */    
    defined('PLATFORM_SUPER_ADMIN') ?   null : define('PLATFORM_SUPER_ADMIN' , 10);
    defined('ZIPPO_PLATFORM_ADMIN') ?   null : define('ZIPPO_PLATFORM_ADMIN' , 9);
    defined('ZIPPO_MANAGEMENT')     ?   null : define('ZIPPO_MANAGEMENT' , 8);
    defined('ZIPPO_OPERATIONS')     ?   null : define('ZIPPO_OPERATIONS' , 7);
    defined('ZIPPO_FINANCE')        ?   null : define('ZIPPO_FINANCE' , 6);
    defined('ZIPPO_TREASURY')       ?   null : define('ZIPPO_TREASURY' , 5);
    defined('ZIPPO_OUTLET_STAFF')   ?   null : define('ZIPPO_OUTLET_STAFF' , 2);
    defined('ZIPPO_OUTLET_JUNIOR_STAFF')   ?   null : define('ZIPPO_OUTLET_JUNIOR_STAFF' ,  1);
    defined('GUEST_USER')           ?   null : define('GUEST_USER' ,  0);  
    defined('BANNED_USER')           ?   null : define('BANNED_USER' ,  0);  
